...
const UI: Record<string, string[]> = {
  ...
  share: ['M21 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z', 'M9 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z', 'M21 19a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z', 'M8.6 13.5 15.4 17.5', 'M15.4 6.5 8.6 10.5'],
